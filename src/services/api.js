  ...
  // const tempAdminToken='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4Y2VjMTViNzdhODMyOGYzMmJmMWMyOCIsImlhdCI6MTc1ODc3MDgzMiwiZXhwIjoxNzY2NTQ2ODMyfQ.VfrMLZKWqo7GxLvz0zHXKabpA8OiTeFjvLuIx19d9Fs';
  ...
  //   // Check if localStorage is available (important for mobile browsers)
  //   isStorageAvailable: () => {
  //     try {
  ...
  //       return true;
  //     } catch (e) {
  //       console.error('[bookingFlow] localStorage not available:', e);
  //       return false;
  //     }
  //   },
  ...
  //   save: () => {
  //     if (!bookingFlow.isStorageAvailable()) {
  //       console.error('[bookingFlow] localStorage not available - cannot save data');
  //       return false;
  //     }
  ...
  //     };
  //     console.log('[bookingFlow] Saving to localStorage:', dataToSave);
  //     try {
  //       const dataString = JSON.stringify(dataToSave);
  //       console.log('[bookingFlow] Data string length:', dataString.length);
  //       localStorage.setItem('bookingFlow', dataString);
  //       console.log('[bookingFlow] Successfully saved to localStorage');
        
  //       // Verify the save worked
  //       const verifyData = localStorage.getItem('bookingFlow');
  //       if (verifyData) {
  //         const parsedVerify = JSON.parse(verifyData);
  //         console.log('[bookingFlow] Verification - data exists in localStorage:', !!parsedVerify.selectedTimeSlot);
  //         return true;
  //       } else {
  //         console.error('[bookingFlow] Verification FAILED - data not found in localStorage after save!');
  //         return false;
  //       }
  //     } catch (error) {
  //       console.error('[bookingFlow] Failed to save to localStorage:', error);
  //       console.error('[bookingFlow] Error details:', {
  ...
  //       console.log('[bookingFlow] Loading from localStorage - raw data exists:', !!saved);
        
  //       if (saved) {
  //         const data = JSON.parse(saved);
  //         console.log('[bookingFlow] Parsed data:', data);
  ...
  //         console.log('[bookingFlow] Loaded data successfully:', {
  //           selectedServices: bookingFlow.selectedServices.length,
  //           selectedProfessionals: Object.keys(bookingFlow.selectedProfessionals).length,
  //           selectedDate: bookingFlow.selectedDate,
  //           selectedTimeSlot: !!bookingFlow.selectedTimeSlot,
  //           bookingConfirmation: !!bookingFlow.bookingConfirmation
  //         });
  ...
  //         return data;
  //       } else {
  //         console.log('[bookingFlow] No saved data found in localStorage');
  //         return {
  //           selectedServices: [],
  //           selectedProfessionals: {},
  //           selectedDate: null,
  ...
  //       }
  //     } catch (error) {
  //       console.error('[bookingFlow] Failed to load from localStorage:', error);
  //       console.error('[bookingFlow] Error details:', {
  //         message: error.message,
  //         name: error.name,
  //         stack: error.stack
...
// const API_BASE_URL = 'https://spabacklat.onrender.com/api/v1';
const API_BASE_URL = 'https://spabacklat.onrender.com/api/v1';
const tempAdminToken='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4Y2VjMTViNzdhODMyOGYzMmJmMWMyOCIsImlhdCI6MTc1ODg4MjQ2NiwiZXhwIjoxNzY2NjU4NDY2fQ.7-a1r3J4UnIzGTkE4EVT6wMfJzhcXTEXtskhT1ebXY8';
// Helper function to handle API responses
const handleResponse = async (response) => {
  if (!response.ok) {
    const errorData = await response.json().catch(() => ({}));
